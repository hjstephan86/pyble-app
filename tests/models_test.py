...
from models import BibleListResponse, BookResponse, ChapterResponse, VerseResponse
...
class TestModels(unittest.TestCase):
    ...
    def test_chapter_response_empty_verses(self):
        ...
        chapter = ChapterResponse(
            book="1. Mose", chapter=1, verses={}, translation="Elberfelder1905"
        )
    ...
    def test_chapter_response_serialization(self):
        ...
        chapter = ChapterResponse(
            book="1. Mose", chapter=1, verses=verses_data, translation="Elberfelder1905"
        )
    ...
    def test_book_response_valid(self):
        ...
        chapters_data = {
            ...
            2: {1: "Und die Himmel und die Erde wurden vollendet."},
        }
    ...
    def test_book_response_empty_chapters(self):
        ...
        book = BookResponse(book="1. Mose", chapters={}, translation="Elberfelder1905")
    ...
    def test_book_response_complex_structure(self):
        ...
        complex_chapters = {
            1: {1: "Verse 1:1", 2: "Verse 1:2", 3: "Verse 1:3"},
            2: {1: "Verse 2:1", 2: "Verse 2:2"},
            3: {1: "Verse 3:1"},
        }

        book = BookResponse(
            book="Test Book", chapters=complex_chapters, translation="Test Translation"
        )
    ...
    def test_book_response_serialization(self):
        ...
        chapters_data = {1: {1: "Im Anfang schuf Gott die Himmel und die Erde."}}

        book = BookResponse(
            book="1. Mose", chapters=chapters_data, translation="Elberfelder1905"
        )
    ...
    def test_model_validation_edge_cases(self):
        ...
        long_text = "A" * 10000
        verse = VerseResponse(
            book=long_text, chapter=1, verse=1, text=long_text, translation=long_text
        )
        self.assertEqual(len(verse.text), 10000)

        # Test with zero values
        verse_zero = VerseResponse(
            book="Book", chapter=0, verse=0, text="", translation="Translation"
        )
        ...
        verse_negative = VerseResponse(
            book="Book", chapter=-1, verse=-1, text="Text", translation="Translation"
        )
