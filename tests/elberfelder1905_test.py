...
0#1. Mose#1#11#Und Gott sprach: Die Erde lasse Gras hervorsprossen, Kraut, das Samen hervorbringe, Fruchtbäume, die Frucht tragen nach ihrer Art, in welcher ihr Same sei auf der Erde! Und es ward also."""
    ...
    def test_load_text_with_mock(self):
        ...
        self.assertEqual(verse11, "Und Gott sprach: Die Erde lasse Gras hervorsprossen, Kraut, das Samen hervorbringe, Fruchtbäume, die Frucht tragen nach ihrer Art, in welcher ihr Same sei auf der Erde! Und es ward also.")
    ...
    def test_load_text_file_not_found(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertTrue(any('Error loading Luther1912' in str(call) for call in mock_print.call_args_list))
